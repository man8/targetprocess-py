...
:class:`targetprocess_py._base.Entity` or :class:`targetprocess_py._base.NamedEntity`
directly.

Re-exported by :mod:`targetprocess_py.models`, which stays the import surface
callers use.
"""

from pydantic import Field

from targetprocess_py._base import Entity, NamedEntity
from targetprocess_py._dates import TPDateTime
from targetprocess_py._nested import EntityRef, EntityTypeRef, UserRef
...
class EntityType(NamedEntity):
    ...
    :class:`targetprocess_py.models.EntityTypeRef` is the *reference* shape other
...
class Term(Entity):
    ...
    extends :class:`targetprocess_py._base.Entity` directly. TP declares the

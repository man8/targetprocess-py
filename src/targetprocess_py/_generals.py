...
they inherit :class:`targetprocess_py._base.GeneralEntity` and declare their own
...
from targetprocess_py._base import GeneralEntity
from targetprocess_py._dates import TPDateTime
from targetprocess_py._nested import AssignedUsers, EntityRef, RefWithImportance

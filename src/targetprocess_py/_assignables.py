...
:class:`targetprocess_py._base.AssignableEntity`. Each class below adds only what
...
from targetprocess_py._base import AssignableEntity
from targetprocess_py._nested import EntityRef, RefWithImportance
